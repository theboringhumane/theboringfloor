...
func TestDiscover(t *testing.T) {
	...
	cases := []struct {
		...
		{"linux env override wins", "linux",
			map[string]string{chromeEnvSuffix: "/opt/chrome/chrome"},
