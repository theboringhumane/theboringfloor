...
export function AgentsNeedAction() {
  return (
    <section id="solutions" className="relative overflow-hidden border-b border-border bg-background">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14">
        ...
        <p className="mx-auto mt-4 max-w-xl text-center text-sm leading-relaxed text-muted-foreground">
          Give the busywork to agents without trading away context. You stay close to the decisions,
        ...
        >
          <source src="/theboringoffice.mp4" type="video/mp4" />
        </video>
        ...
        >
          {roster.map((l) => (
            <span key={l} className="font-mono text-2xl font-semibold tracking-tight opacity-70 md:text-3xl">
              {l}
            </span>
          ))}
        </ScrollReveal>
      ...
      <div className="relative border-t border-border">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-6 py-14 lg:grid-cols-3">
          <ScrollReveal direction="left" className="border border-border bg-card p-5 font-mono text-xs">
            ...
            <div className="mt-3 space-y-2">
              <p className="border border-border px-3 py-2">
                ...
                <span className="ml-2 block text-muted-foreground">Run this action, ask again next time</span>
              </p>
              <p className="border border-border px-3 py-2">
                ALLOW ALWAYS <span className="text-muted-foreground">· a</span>
                <span className="ml-2 block text-muted-foreground">Never ask for this action again</span>
              </p>
            </div>
          </ScrollReveal>
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed">
              Ship the auth fix, get dikastes to review it, and post a digest to #eng when it&apos;s
              green.
            </p>
          ...
          <ScrollReveal direction="right" className="border border-border bg-card p-5 font-mono text-xs">
